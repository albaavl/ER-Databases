...
public class Main {
	...
	public static void createPatient () throws NotBoundException, Exception {
		...
		System.out.print("Date of birth [yyyy-mm-dd]: ");	//TODO no entiendo la mitad de tu funcion entonces yo lo cambiaria a pedir dia, mes, año y luego crear una string con el formato que queremos y nos ahorramos la excepcion, solo habria que controlar el numero de digitos del año, mes y dia
	...
	public static void createWorker() throws Exception {
		...
		//TODO - Esto habrÃ­a q separarlo, no creo q sea buena idea crear shift y worker a la vez.
//TODO AÑADIR EL REGISTER AL FINAL DEL WORKER IGUAL QUE ESTA HECHO EN PATIENT
		Worker w = new Worker();
		Shift s = new Shift();
