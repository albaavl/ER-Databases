...
public class Main {
	...
	public static void createPatient () throws NotBoundException, Exception {
		...
		Integer medCardNumber; //para evitar que se introduzca un paciente con un id igual a uno ya existente
			do { 
				medCardNumber = sc.nextInt(); //para evitar que se introduzca un paciente con un id igual a uno ya existente
		...
		System.out.print("Date of birth [yyyy-mm-dd]: ");	//TODO no entiendo la mitad de tu funcion entonces yo lo cambiaria a pedir dia, mes, a�o y luego crear una string con el formato que queremos y nos ahorramos la excepcion, solo habria que controlar el numero de digitos del a�o, mes y dia
...
// 		//TODO - Esto habría q separarlo, no creo q sea buena idea crear shift y worker a la vez.
// //TODO A�ADIR EL REGISTER AL FINAL DEL WORKER IGUAL QUE ESTA HECHO EN PATIENT
// 		Worker w = new Worker();
// 		Shift s = new Shift();
...
// 	}
	...
	public static void createWorker() throws Exception{
		...
		System.out.println("Let's proceed with the registration, the username and password will be autogenerated by the system:");
		register(w.getWorkerName(), w.getWorkerSurname(), w.getWorkerId());  //TODO - bastante seguro de q esto esta bien peero quizás no
	 ...
	 * @throws Exception
	 */
	public static void addShift(int workerId) throws Exception{
		Shift s = new Shift();
		...
		System.out.print("Room: "); //TODO - Deberíamos limitar esto. (como la parte de abajo)
		Integer roomER = sc.nextInt();
		s.setRoom(roomER);
	...
	private static void adAccessToPatientsProfile() throws Exception {
		...
		do {
			key = sc.nextInt();
		// name surname Gender Bloodtype Allergies Dateofbirth Checkindate 	Address Hospitalization
			...
			switch (key) {
				case 1: //Cambiar cosas del patient
					...
					do {
						...
						switch (key2) { //TODO - crear funcion update patient en sql :)
							case 1: //nombre
							...
							case 3: //genero
								...
								String newGender;
								//TODO - copiar codigo aqui
								ctrl2 = 1; // lo mismo q arriba
								break;
							case 4: //sangre
								System.out.print("Introduce the new blood type: ");
								String newBloodType;
								//TODO - copiar codigo aqui.
								ctrl2 = 1; // lo mismo q arriba
								break;
							...
							case 6: // bdate
								...
								break;
							case 7: //check in
								System.out.print("Introduce the new check-in date: ");
								Date newCheckInDate;
								//TODO - copiar codigo aqui
								ctrl2 = 1; // lo mismo q arriba
								break;
